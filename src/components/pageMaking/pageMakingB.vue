        ...
        <div class="pageMaking-container">
            ...
            <div class="pageMaking-min">
                <draggable v-model="list"
                           ...
                           :options="{ chosenClass:'active',scroll:true,group:{ name:'people', pull:'clone',put:true}}"
                           handle=".handle"
                           ghost-class="ghost"
                           @end="onEnd"
                           @add="onAdd"
    ...
    methods: {
      ...
      handleWidgetColAdd($event, row, colIndex){
        ...
        if (row.type === "grid") {
          ...
          item.tagName === 'DIV' && row.splice(oldIndex, 0, row.columns[colIndex].list[newIndex]);
